var mapInit = function() {
    ...
    function getRouteForMap() { 
        if (hasMap()) {
           ...
           var url = '/tracks/getrouteformap' + $('#routeSelect').val();
    ...
    function createMarker(latitude, longitude, speed, direction, distance, locationMethod, gpsTime,
        ...
        if (finalLocation) {
            ...
            iconUrl = '/assets/coolgreen2_small.png';
        }

        var markerIcon = new L.Icon({
                iconUrl:      iconUrl,
                shadowUrl:    '/assets/coolshadow_small.png',
                iconSize:     [12, 20],
                shadowSize:   [22, 20],
                iconAnchor:   [6, 20],
                shadowAnchor: [6, 20],
    ...
    function deleteRoute() {
        if (hasMap()) {
            ...
            if (answer){
                var url = '/tracks/deleteroute' + $('#routeSelect').val();
